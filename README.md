...
- **AI 助手**：设置中自定义 AI 服务地址与 API Key（支持连接测试），AI 可读取已登录账号的喜欢歌单、热曲排行与每日推荐，提供个性化推荐；AI 推荐的歌单可一键在网易云 + QQ音乐双平台匹配，并自动生成软件内本地歌单（可点开查看、删除，持久化保存）。
...
- **软件内自动更新**：基于 GitHub Releases 检查新版本，设置页显示当前版本并支持手动检测，发现更新后可一键下载并重启安装。
